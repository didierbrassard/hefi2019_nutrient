...
%put WARNING: default path for PDF updated to &path./NCI/MCMC&suffix./markovchains/ (L3580, 3587);
/*****************************************************************************/
/*****************************************************************************/
/*                                                                           */
/*                            MULTIVAR_MCMC MACRO                            */
...
%macro multivar_mcmc(data                        =,
  ...
  %if (&traceplots_method1_gpath^=%str()) %then %do;
    ...
    %if (&traceplots_method2_file_pdf^=%str()) %then %do;
      ods pdf file="&path./NCI/MCMC&suffix./markovchains/&traceplots_method2_file_pdf." notoc;
      run;
    %end;
  %end;
