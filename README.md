...
<td headers="Description" class="gt_row gt_left"><div class='gt_from_md'><p>Based on CCHS 2015 - Nutrition PUMF data, calculate intakes of HEFI-2019 dietary constituents per respondent and recall. Prepare an input data for the NCI MCMC mutlivaraite method. Look at proportion of respondents with zero intake</p>
</div></td>
