...
slice_mc_t_out  <- 
  function(nutrient,nutrient_label,proportion=0.05){
  ...
  dplyr::slice_sample(#prop  = (proportion/500) , # Assuming 500 pseudo-individuals
                      n = 200, # Better to use fixed sample size for consistency purpose
...
if(docx == "Y"){
  # save as docx
 object |>
    gt::gtsave(here::here("Manuscript",paste0(label,".docx")))
} else {
...
# *********************************************************************** #
#                 Plot score distribution using BoxPlot                   #
# *********************************************************************** #
...
hefi_distrib_hist <- 
  ...
  geom_histogram(binwidth = 2, aes(y=after_stat(density)), colour="black",fill="white") +
  geom_density(kernel="gaussian",fill="black",alpha=0.1) +
  # geom_vline(xintercept=43.1,colour=MetBrewer::met.brewer("Hiroshige")[[1]],
  #            linetype="longdash",size=1.5) +
  labs(x="Total HEFI-2019 score, points",y="Density")+ 
  theme_bw() 
...
# ********************************************** #
  ...
  ggplot2::ggsave(here::here('Manuscript', 'Fig1_hefi_distrib.pdf'),
        plot=hefi_distrib_plot, dpi=300, width=7,height=7, units="in",scale=1,device = cairo_pdf)

  ggplot2::ggsave(here::here('Manuscript', 'Fig1_hefi_distrib.png'),
...
# ********************************************** #
  ...
  ggplot2::ggsave(here::here("Manuscript","Fig2_prob_ear.pdf"),
        plot=mrg_prob_plot_all, dpi=300, width=7,height=5, units="in",scale=1.05,device = cairo_pdf)

  ggplot2::ggsave(here::here("Manuscript","Fig2_prob_ear.png"),
...
# ********************************************** #
  ...
  ggplot2::ggsave(here::here('Manuscript','Fig3_reg_hefi_nut.pdf'),
        plot=linreg_nut_all, dpi=300, width=13.5,height=7.5, units="in",scale=1,device = cairo_pdf)

  ggplot2::ggsave(here::here('Manuscript','Fig3_reg_hefi_nut.png'),
...
# ********************************************** #
  ...
  ggplot2::ggsave(here::here('Manuscript','Fig4_hypothetical_inrease.pdf'),
        plot=logregplot, dpi=300, width=10,height=7, units="in",scale=0.8,device = cairo_pdf)
  
  ggplot2::ggsave(here::here('Manuscript','Fig4_hypothetical_inrease.png'),
